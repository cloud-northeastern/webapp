const { createAssignment, deleteAssignment,updateAssignment,getAllAssignments, getAssignment,checkDb, allReq, BadReq, submitAssignment} = require('./assignmentcontroller')
