const { createAssignment,submitAssignment, deleteAssignment,updateAssignment,getAllAssignments, getAssignment,checkDb, allReq, BadReq} = require('./assignmentcontroller')
const {basicAuth}= require('../auth/validation.js')
const router = require('express').Router();

router.post('/',checkDb, basicAuth, createAssignment);
router.post('/:id/submission',checkDb, basicAuth, submitAssignment);
